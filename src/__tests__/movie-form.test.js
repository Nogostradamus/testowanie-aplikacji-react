...
import { render, fireEvent, wait, getByLabelText, screen } from '@testing-library/react';
import MovieForm from '../components/movie-form';

global.fetch = require('jest-fetch-mock');

const movie = {id: 3, title: 'Pierwszy film', description: 'Opis pierwszego filmu'};
...
describe("MovieForm component", () => {
  ...
  test("should trigger API call when click new movie btn", async () => {
    ...
    fireEvent.change(titleInput, { target: { value: "Tittle1"}});
